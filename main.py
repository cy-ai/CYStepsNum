...
# 开启根据地区天气情况降低步数（默认关闭）
open_get_weather = True #sys.argv[3]
...
min_dict = {time_list[0]: 4000, time_list[1]: 8000, time_list[2]: 12000, time_list[3]: 18999, time_list[4]: 28999, time_list[5]: 38999, time_list[6]: 48999}
# 最大步数（例如现在设置意思是在8点（你设置的第一个时间点默认8）运行会在1500到2999中随机生成一个数提交（开启气候降低步数会乘系数K）10点3000~4999。。。以此类推，步数范围建议看懂了再改，没看懂直接默认就好）
max_dict = {time_list[0]: 8000, time_list[1]: 12000, time_list[2]: 18999, time_list[3]: 28999, time_list[4]: 38999, time_list[5]: 48999, time_list[6]: 69999}
# 设置结束
